...
namespace Content.Server.VendingMachines
{
    public sealed class VendingMachineSystem : SharedVendingMachineSystem
    {
        ...
        public override void Initialize()
        {
            ...
            SubscribeLocalEvent<VendingMachineComponent, AfterInteractUsingEvent>(HandleAfterInteractUsing); //LPP vending-storage
        ...
        private void EjectItem(EntityUid uid, VendingMachineComponent? vendComponent = null, bool forceEject = false)
        {
            ...
            vendComponent.NextEntityToEject = null; // LPP vending-storage
            vendComponent.ThrowNextItem = false;
        }
