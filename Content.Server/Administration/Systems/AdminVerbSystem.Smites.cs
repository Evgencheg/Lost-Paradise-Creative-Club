    ...
    private void AddSmiteVerbs(GetVerbsEvent<Verb> args)
    {
        ...
        if (TryComp<FlammableComponent>(args.Target, out var flammable))
        {
            Verb flames = new()
            {
                ...
                Category = VerbCategory.Smite,
                Icon = new SpriteSpecifier.Texture(new ("/Textures/Interface/Alerts/Fire/fire-icon.png")),
                Act = () =>
                {
        ...
        /*if (TryComp<DiseaseCarrierComponent>(args.Target, out var carrier))
        {
            Verb lungCancer = new()
            {
                ...
                Act = () =>
                {
                    _diseaseSystem.TryAddDisease(args.Target, _prototypeManager.Index<DiseasePrototype>("StageIIIALungCancer"),
                        carrier);
                },
                Impact = LogImpact.Extreme,
