...
station-goal-solar-panels =
    ...
    Для этого вам понадобится заказать все необходимые материалы в отделе снабжения и после построить 2 новые ветки по 60 солнечных панелей на каждой (ОТДЕЛЬНО ДРУГ ОТ ДРУГА) инженерным отделом.
    А так же обеспечить изолированность производимой ими энергии в новые 3 СМЭСа не подключенные к общей сети станции. Не забыть поставить по трекеру на каждую ветку.
    =============================================
station-goal-artifacts =
    ...
    Документ должен быть удостоверен печатью научного директора.
    =============================================
station-goal-bank =
    ░░████░░████░░
    ░░█░░█░░█░░█░░              ЦЕЛЬ СТАНЦИИ
