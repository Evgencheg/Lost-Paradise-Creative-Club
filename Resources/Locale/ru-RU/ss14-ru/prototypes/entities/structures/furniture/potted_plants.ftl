...
ent-PottedPlant24 = { ent-PottedPlantBase }
    .desc = { ent-PottedPlantBase.desc }
ent-PottedPlantRD = комнатное растение научдика
    .desc = Подарок от сотрудников ботанического отдела, презентованный после переназначения научдика. На нем висит бирка с надписью "Возвращайся, слышишь?". Выглядит не очень здоровым...
