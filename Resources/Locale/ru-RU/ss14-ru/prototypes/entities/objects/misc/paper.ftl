...
ent-PenCap = перьевая ручка капитана
    .desc = Ручка, сделанная из чистого золота, разукрашенная в синие тона. То, что нужно каждому писателю, для написания историй о похотливой ксенодеве. Использует самые дорогие чернила.
    .suffix = { "Ручка" }
...
ent-PenHop = перьевая ручка главы персонала
    .desc = Ручка, разукрашенная в темные тона комбинезона главы персонала.
    .suffix = { "Ручка" }
