...
ent-LPPClothingUniformJumpSkirtSecEngineer = Короткая юбка бригтехника
    .desc = Очевидно что короткая юбка поможет ей поменять лампочку на потолкe в кабинете у ГСБ
...
ent-ClothingUniformJumpskirtResearchDirector = водолазка научного директора
