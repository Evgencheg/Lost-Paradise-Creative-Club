...
job-description-security-enginer = не дайте бригу пропасть во тьме. Ремонтируйте постройки в бриге, и улучшайте его
...
job-description-cap-syndicate = Капитан. где должен присматривать за базами SD-2/1.
job-description-head-of-personnel-syndicate = Глава персонала. пишет Бумаги как отчёт, и выдаёт доступа.
job-description-head-of-Security-syndicate = Начальник службы синдигата. должен проводить допрос у заключенных. А так же присматривать за свойм отделом.
job-description-Security-syndicate = службы синдигата. должен слушаться начальника, который должен указывать. А так же проводить допрос заключенных.
job-description-chef-syndicate = Сервисный. должен ухаживать за станцией, что бы не умерли от голода или обезвоживание.
job-description-scientist-syndicate = Учёный. должен изучать новые технологии. А также выполнять цели от Капитана или Главы персонала.
job-description-Medical-syndicate = Врач. помогает не умереть или же помощь вставить обратно конечность.
job-description-ShaftMiner-syndicate = Утилизатор. должен добывать ресурсы, и приносить новые вещи из обломков. А также выполнять цели от Капитана.
job-description-engineer-syndicate = Инженер мастер. должен чинить и знать как достать элетричество,и уметь собирать турели. А также выполнять цели от Капитана.
job-description-prisoner-syndicate = Заключеный. вы как то попали в плен, и вам дадут запрос о том как вы заметили и попали в суд.
