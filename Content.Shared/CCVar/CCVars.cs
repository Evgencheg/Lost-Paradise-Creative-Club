...
namespace Content.Shared.CCVar
{
    ...
    public sealed class CCVars : CVars
    {
        ...
        public static readonly CVarDef<float> LobbyMusicVolume =
            CVarDef.Create("ambience.lobby_music_volume", 1f, CVar.ARCHIVE | CVar.CLIENTONLY);
        ...
        */
        ...
        public static readonly CVarDef<string> InfoLinksDiscord =
            CVarDef.Create("infolinks.discord", "https://discord.gg/v5mGmMzAdB", CVar.SERVER | CVar.REPLICATED);

        /// <summary>
        /// Link to website to show in the launcher.
        /// </summary>
        public static readonly CVarDef<string> InfoLinksForum =
            CVarDef.Create("infolinks.forum", "https://discord.gg/v5mGmMzAdB", CVar.SERVER | CVar.REPLICATED);
        ...
        public static readonly CVarDef<string> InfoLinksWebsite =
            CVarDef.Create("infolinks.website", "https://boosty.to/lost-paradise", CVar.SERVER | CVar.REPLICATED);

        /// <summary>
        /// Link to wiki to show in the launcher.
        /// </summary>
        public static readonly CVarDef<string> InfoLinksWiki =
            CVarDef.Create("infolinks.wiki", "http://wiki.lost-paradise.space/", CVar.SERVER | CVar.REPLICATED);
        ...
        public static readonly CVarDef<string> InfoLinksBugReport =
            CVarDef.Create("infolinks.bug_report", "https://discord.gg/v5mGmMzAdB", CVar.SERVER | CVar.REPLICATED);

        /// <summary>
        /// Link to site handling ban appeals. Shown in ban disconnect messages.
        /// </summary>
        public static readonly CVarDef<string> InfoLinksAppeal =
            CVarDef.Create("infolinks.appeal", "https://discord.gg/v5mGmMzAdB", CVar.SERVER | CVar.REPLICATED);
