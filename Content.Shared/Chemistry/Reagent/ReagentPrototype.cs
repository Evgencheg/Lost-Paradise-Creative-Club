...
namespace Content.Shared.Chemistry.Reagent
{
    ...
    public sealed partial class ReagentPrototype : IPrototype, IInheritingPrototype
    {
        ...
        /// <summary>
        /// Может ли хранить болезнь после контакта с зараженным
        /// </summary>
        [DataField("diseaseReagent")]
        public bool DiseaseReagent = false;
        ...
        [DataField("hideFromGuide")]            //если true - эффекты не отображаются в GuideBook
        public bool HideFromGuide = false;
