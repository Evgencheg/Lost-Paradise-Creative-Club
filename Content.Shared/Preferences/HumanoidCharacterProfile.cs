...
namespace Content.Shared.Preferences
{
    ...
    public sealed partial class HumanoidCharacterProfile : ICharacterProfile
    {
        ...
        private readonly List<string> _donatePreferences = new(); // Lost Paradise Donate Preference
        /// <summary>
        ...
        public List<string> DonatePreferences => _donatePreferences; // Lost Paradise Donate Preference
        /// <summary>
        ...
        public HumanoidCharacterProfile(HumanoidCharacterProfile other)
            : this(other.Name,
                ...
                new List<string> (other.DonatePreferences))
        {
        }
        ...
        public override int GetHashCode()
        {
            ...
            hashCode.Add(_donatePreferences);
            hashCode.Add(Name);
