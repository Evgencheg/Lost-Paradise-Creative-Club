...
//using Content.Client.LPP.LustIndicator;
using Serilog;
...
public sealed class ChatUIController : UIController
{
    ...
    //[UISystemDependency] private readonly LustIndicatorClientSystem? _lewdsys = default;
    ...
    public static readonly Dictionary<char, ChatSelectChannel> PrefixToChannel = new()
    {
        ...
        //{SharedChatSystem.EmotesLewd, ChatSelectChannel.EmotesLewd},
    ...
    public static readonly Dictionary<ChatSelectChannel, char> ChannelPrefixes = new()
    {
        ...
        //{ChatSelectChannel.EmotesLewd, SharedChatSystem.EmotesLewd},
    ...
    public override void Initialize()
    {
        ...
        //_input.SetInputCommand(ContentKeyFunctions.FocusLewdEmote,
        //    InputCmdHandler.FromDelegate(_ => FocusChannel(ChatSelectChannel.EmotesLewd)));
