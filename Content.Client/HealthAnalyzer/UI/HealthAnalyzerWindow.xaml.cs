...
namespace Content.Client.HealthAnalyzer.UI
{
    ...
    public sealed partial class HealthAnalyzerWindow : FancyWindow
    {
        ...
        public void Populate(HealthAnalyzerScannedUserMessage msg)
        {
            ...
            /*if (_entityManager.HasComponent<DiseasedComponent>(target.Value))
            {
                Virus.Text = ($"{Loc.GetString("disease-scanner-diseased")}\n");
            }
            else
            {
                Virus.Text = $"{Loc.GetString("disease-scanner-not-diseased")}\n";
            }*/
