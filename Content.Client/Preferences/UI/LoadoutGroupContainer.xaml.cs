...
public sealed partial class LoadoutGroupContainer : BoxContainer
{
    ...
    public LoadoutGroupContainer(RoleLoadout loadout, LoadoutGroupPrototype groupProto, ICommonSession session, IDependencyCollection collection, bool isSponsor)
    {
        RobustXamlLoader.Load(this);
        _groupProto = groupProto;

        RefreshLoadouts(loadout, session, collection, isSponsor);
    }

    /// <summary>
    /// Updates button availabilities and buttons.
    /// </summary>
    public void RefreshLoadouts(RoleLoadout loadout, ICommonSession session, IDependencyCollection collection, bool isSponsor)
    {
        ...
        foreach (var loadoutProto in _groupProto.Loadouts)
        {
            ...
            if (loadProto.ForSponsor && !isSponsor)
                continue;
