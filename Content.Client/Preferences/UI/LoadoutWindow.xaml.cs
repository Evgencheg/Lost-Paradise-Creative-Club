...
//using Content.Client.LPP.Sponsors;
...
public sealed partial class LoadoutWindow : FancyWindow
{
    ...
    public LoadoutWindow(RoleLoadout loadout, RoleLoadoutPrototype proto, ICommonSession session, IDependencyCollection collection)
    {
        ...
        //checkSponsorSystem.GoCheckSponsor(session.AttachedEntity?.ToString());
        IsSponsor = false;//checkSponsorSystem.IsSponsor;
        ...
        foreach (var group in proto.Groups)
        {
            ...
            var container = new LoadoutGroupContainer(loadout, protoManager.Index(group), session, collection, IsSponsor);
    ...
    public void RefreshLoadouts(RoleLoadout loadout, ICommonSession session, IDependencyCollection collection)
    {
        ...
        {
            group.RefreshLoadouts(loadout, session, collection, IsSponsor);
        }
    }
}
